...
public class DAOFactory {
	...
	public static ActorDAO createActorDAO() {
		...
		actorDAO.setSession(HibernateUtil.getSessionFactory().getCurrentSession());
		return actorDAO;
	}
	
	public static Dvd_releaseDAO createDvd_releaseDAO() {
		Dvd_releaseDAO dvd_releaseDAO = new Dvd_releaseDAO();
		dvd_releaseDAO.setSession(HibernateUtil.getSessionFactory().getCurrentSession());
